...
import 'package:n_baz/screens/my_profile.dart';
    ...
    return MultiProvider(
      ...
      child: GlobalLoaderOverlay(
        ...
        overlayWidget: Center(
          child: Image.asset("assets/images/loader1.png", height: 100, width: 100,),
        ),
        child: Consumer<GlobalUIViewModel>(
          builder: (context, loader1, child) {
            if(loader1.isLoading){
